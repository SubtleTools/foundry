 ...
 * ```
 */
export declare const NoTabConversion = -1;
/**
 ...
 */
export declare function StyleRunes(str: string, indices: number[], matched: Style, unmatched: Style): string;
/**
 ...
 */
export declare function renderWhitespace(width: number, options?: WhitespaceOptions): string;
/**
 ...
 */
export declare function WithWhitespaceForeground(color: ColorValue): WhitespaceOption;
/**
 ...
 * @see {@link Place} - For positioning text with styled whitespace fill
 */
export declare function WithWhitespaceBackground(color: ColorValue): WhitespaceOption;
/**
 ...
 */
export declare function Place(width: number, height: number, hPos: Position, vPos: Position, str: string, options?: WhitespaceOptions): string;
/**
 ...
 * @see {@link Position} - For position value documentation
 */
export declare function PlaceHorizontal(width: number, pos: Position, str: string, options?: WhitespaceOptions): string;
/**
 ...
 * @see {@link Position} - For position value documentation
 */
export declare function PlaceVertical(height: number, pos: Position, str: string, options?: WhitespaceOptions): string;
/**
 ...
 */
export declare function getFirstRune(str: string): string;
/**
 ...
 */
export declare function padCenter(str: string, width: number): string;
/**
 ...
 */
export declare function toRunes(str: string): string[];
/**
 ...
 */
export declare function runeCount(str: string): number;
/**
 ...
 */
export declare function hasANSI(str: string): boolean;
/**
 ...
 */
export declare function spaces(width: number): string;
/**
 ...
 */
export declare function GetColorProfile(): ColorProfile;
export declare function SetColorProfile(profile: ColorProfile): void;
/**
