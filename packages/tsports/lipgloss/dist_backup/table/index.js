 ...
 */
// Data management
export { dataToMatrix, newStringData, newTableFilter, StringData, TableFilter, } from './data';
// Resizing and layout
export { Resizer } from './resizing';
// Core table classes and interfaces
export { defaultStyles, HeaderRow, newTable, Table } from './table';
// Utilities
export { btoi, clamp, distributeProportionally, ensureMinimum, fillArray, mapArray, max, maxOf, median, min, minOf, safeArrayAccess, sum, } from './utils';
