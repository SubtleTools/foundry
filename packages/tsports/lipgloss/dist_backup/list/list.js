...
export class List {
    ...
    enumeratorStyleFunc(func) {
        this.tree.enumeratorStyleFunc((children, index) => {
     ...
     */
    indenter(indenter) {
        this.tree.indenter((children, index) => {
     ...
     */
    itemStyleFunc(func) {
        this.tree.itemStyleFunc((children, index) => {
            return func(children, index);
        });
        return this;
    }
    ...
    enumerator(enumerator) {
        this.tree.enumerator((children, index) => {
