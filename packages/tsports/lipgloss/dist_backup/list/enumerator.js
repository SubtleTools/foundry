 ...
 * ```
 */
export const Alphabet = (_items, index) => {
 ...
 * ```
 */
export const Arabic = (_items, index) => {
    return `${index + 1}.`;
};
/**
 ...
 * ```
 */
export const Roman = (_items, index) => {
 ...
 * ```
 */
export const Bullet = (_items, _index) => {
    return '•';
};
/**
 ...
 * ```
 */
export const Asterisk = (_items, _index) => {
    return '*';
};
/**
 ...
 * ```
 */
export const Dash = (_items, _index) => {
    return '-';
};
