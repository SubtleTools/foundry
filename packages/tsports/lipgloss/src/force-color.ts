 ...
 * ```
 */
export function enableForceColor(options: ForceColorOptions = {}): void {
 ...
 */
export function disableForceColor(): void {
 ...
 */
export function isForceColorEnabled(): boolean {
 ...
 */
export function getForceColorConfig(): Readonly<typeof forceColorState> {
 ...
 * ```
 */
export function setForceColorEnv(value: 0 | 1 | 2 | 3 | undefined): void {
  if (typeof process === 'undefined') {
 ...
 * ```
 */
export function overrideNoColor(override: boolean): void {
  if (typeof process === 'undefined') {
 ...
 * ```
 */
export function withForceColor<T>(fn: () => T, options: ForceColorOptions = {}): T {
  // Save current state
 ...
 */
export function colorProfileToLevel(profile: ColorProfile): 0 | 1 | 2 | 3 {
  switch (profile) {
 ...
 */
export function levelToColorProfile(level: 0 | 1 | 2 | 3): ColorProfile {
  switch (level) {
    case 0:
