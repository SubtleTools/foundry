...
export type { Color as ColorInterface, Environ, File, Output as OutputInterface, OutputOption } from './types.js';
 ...
 */
export function WithEnvironment(environ: import('./types.js').Environ): OutputOption<Output> {
  return (o: Output) => {
    o.environ = environ;
  };
}
